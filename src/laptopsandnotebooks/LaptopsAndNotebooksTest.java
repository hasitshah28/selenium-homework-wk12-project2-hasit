...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"), "Has");
        sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"), "Shah");
        sendTextToElement(By.xpath("//input[@id='input-payment-email']"), "has1234@gmail.com");
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-city']"), "Liverpool");
